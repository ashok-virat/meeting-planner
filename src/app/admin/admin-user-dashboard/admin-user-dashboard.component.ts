...
export class AdminUserDashboardComponent implements OnInit {
  ...
  constructor(public socketService:SocketService,public toastr: ToastrService,public service:ServiceService,public router: Router,public _route:ActivatedRoute,private modal: NgbModal) {
  ...
  closeOpenMonthViewDay() {
    ...
    public getallevets=()=>{
      this.service.getallevents(this.userId,this.authToken).subscribe( data => {
