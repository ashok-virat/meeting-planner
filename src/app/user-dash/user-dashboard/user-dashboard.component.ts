...
export class UserDashboardComponent implements OnInit {
  ...
  constructor(public socketService:SocketService,public toastr: ToastrService,public service:ServiceService,public _route: ActivatedRoute, public router: Router, private modal: NgbModal) {
