...
export class UserEventComponent implements OnInit {
  ...
  constructor(public toastr: ToastrService,public service:ServiceService,public router: Router,public _route:ActivatedRoute,private modal: NgbModal,private config:NgbDatepickerConfig,public socketService:SocketService) { }
